---
name: "source-command-light-mode-audit"
description: "Scan all CSS for hardcoded colors that won't adapt to light mode"
---

# source-command-light-mode-audit

Use this skill when the user asks to run the migrated source command `light-mode-audit`.
...
- The hardcoded value
- What CSS var should replace it (use the mapping rules in `AGENTS.md`)
